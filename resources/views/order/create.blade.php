...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Start New Order</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
        ...
        <div class="card shadow col-12">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"> Start Order Now >></h6>
            </div>
            <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('postquote') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-12 mt-5">
                                ...
                                <textarea required class="form-control" name="description" placeholder="Add Description" id="description" cols="40"
                                    rows="10"></textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
