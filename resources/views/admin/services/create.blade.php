...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Service') }}
                        <a href="{{ route('services.index') }}" class="float-right" href=""><i
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('services.store') }}">
                            ...
                            <div class="row mb-3">
                                <label for="price"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Service Price') }}</label>
