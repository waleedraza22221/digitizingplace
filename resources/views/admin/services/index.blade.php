    ...
    <div class="row">
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                ...
                @endif
                <a href="{{ route('services.create') }}" class="btn btn-primary btn-circle"><i
...
@section('footerscript')
    <script>
        ...
        $('#editmodel').on('show.bs.modal', function(event) {
            ...
            $('form').get(0).setAttribute('action', '/admin/services/' + id);
            $('form').get(1).setAttribute('action', '/admin/services/' + id);
        })
    </script>
@endsection
