...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Services Addon</h1>
    ...
    <div class="row">
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                ...
                @endif
                <a href="{{ route('servicesaddon.create') }}" class="btn btn-primary btn-circle"><i
...
@section('footerscript')
    <script>
        $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('servicesaddon.index') }}',
            columns: [{
                    data: 'id'
                },
                {
        ...
        $('#editmodel').on('show.bs.modal', function(event) {
            ...
            $('form').get(0).setAttribute('action', '/admin/serviceaddon/' + id);
            $('form').get(1).setAttribute('action', '/admin/serviceaddon/' + id);
        })
    </script>
@endsection
